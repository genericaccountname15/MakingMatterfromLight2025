...
class HitCounter(Simulation):
    ...
    def est_npairs(self, angles: list, samples: int)-> list:
        ...
        xray_data = XraySpectra('optimisation_simulation/theory/energy_spectra/data/XrayBath/XraySpectra/',
                                 resolution=0.5)
        gamma_data = GammaSpectra(
            'optimisation_simulation/theory/energy_spectra/data/GammaSpectra/Fig4b_GammaSpecLineouts.mat')
